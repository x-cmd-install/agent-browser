...
[![x-cmd/install — agent-browser Code Quality Monitoring Repo Card](https://repo.x-cmd.io/agent-browser.svg?lang=zh)](https://x-cmd.com/install/agent-browser)
...
合计: **173,922** 行代码（覆盖前 5 种语言、共 **324** 个文件）。
...
- **Star**: 42,956 · **Fork**: 2,882 · **开放 issue**: 674 · **贡献者**: 137

## 累计统计

- **发布数**: 110 · **已合并 PR**: 627 · **开放 PR**: 404 · **已关闭 issue**: 283 · **开放 issue**: 391 · **提交数**: 682
...
_数据快照: `data/card/260921.yml` · 2026-09-21T06:06:07Z._
